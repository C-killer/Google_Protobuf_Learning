...
#ifndef GOOGLE_PROTOBUF_INCLUDED_logInOut_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_logInOut_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_logInOut_2eproto
...
struct TableStruct_logInOut_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_logInOut_2eproto;
namespace RPC {
class LoginRequest;
...
class ResultCode final :
 ...
 private:
  ...
  friend struct ::TableStruct_logInOut_2eproto;
};
// -------------------------------------------------------------------
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_logInOut_2eproto
